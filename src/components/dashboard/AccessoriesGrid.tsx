...
export const AccessoriesGrid = () => (
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
    {/* Nest Wi-Fi */}
    <div className="border-2 border-primary/30 rounded-xl shadow-sm p-2 sm:p-4 relative hover:bg-accent transition-colors h-24 sm:h-32 flex flex-col bg-card">
    ...
    <div className="border-2 border-primary/30 rounded-xl shadow-sm p-2 sm:p-4 relative hover:bg-accent transition-colors h-24 sm:h-32 flex flex-col bg-card">
      <div className="w-8 h-8 sm:w-10 sm:h-10 bg-muted rounded-lg flex items-center justify-center mb-2 sm:mb-3">
        <div className="w-4 h-3 sm:w-5 sm:h-3 bg-card rounded-sm flex flex-col justify-center">
          <div className="h-px bg-muted-foreground mx-0.5 sm:mx-1" />
          <div className="h-px bg-muted-foreground mx-0.5 sm:mx-1 mt-0.5 sm:mt-1" />
          <div className="h-px bg-muted-foreground mx-0.5 sm:mx-1 mt-0.5 sm:mt-1" />
        </div>
      </div>
      <div className="mt-auto">
